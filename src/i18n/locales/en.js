...
const en = {
  ...
  "config.presets.aria": "Palette styles",
  "config.presets.faithful": "Natural",
  "config.presets.tonal": "Calm",
  "config.presets.pop": "Pop",
  "config.presets.accents": "Accents",
  "config.hybrid.tone.title": "Vivid blend",
  "config.hybrid.tone.hint": "From softened average tones to the most vivid exemplar.",
  "config.hybrid.tone.aria": "Vivid blend: {value}",
  "config.hybrid.tone.step.muted": "Muted",
  "config.hybrid.tone.step.soft": "Soft",
  "config.hybrid.tone.step.vivid": "Vivid",
  ...
  "config.hybrid.rarity.step.off": "Off",
  "config.hybrid.rarity.step.subtle": "Subtle",
  "config.hybrid.rarity.step.strong": "Strong",
  "config.hybrid.rarity.step.max": "Max",
  "config.hybrid.spread.title": "Hue spread",
  "config.hybrid.spread.hint":
    "How far apart the picked colors sit — from close tones to a wide fan of hues.",
  "config.hybrid.spread.aria": "Hue spread: {value}",
  "config.hybrid.spread.step.tight": "Tight",
  "config.hybrid.spread.step.natural": "Natural",
  "config.hybrid.spread.step.spread": "Spread",
  "config.hybrid.spread.step.wide": "Wide",
  "config.hybrid.loyalty.title": "Stability",
  "config.hybrid.loyalty.hint":
    "Keeps the live palette from jumping between frames. Higher = steadier colors, lower = instant reaction to scene changes.",
  "config.hybrid.loyalty.aria": "Stability: {value}",
  "config.hybrid.loyalty.step.off": "Off",
  "config.hybrid.loyalty.step.light": "Light",
  "config.hybrid.loyalty.step.firm": "Firm",
  "config.hybrid.loyalty.step.locked": "Locked",
