...
const en = {
  ...
  "slider.colorCountAria": "Number of colors",
  "slider.colorCount": "{count} colors",
  "slider.colorCountLabel": "Colors",
  ...
  "settings.backup.statusOff": "Online backup: not connected",
  "settings.backup.statusOn": "Online backup active",
  "settings.backup.statusBusy": "Backing up…",
  "settings.backup.progress": "{backedUp} / {total} palettes backed up",
  "settings.backup.codePlaceholder": "cc-…",
  "settings.backup.connect": "Connect backup",
  "settings.backup.connectBusy": "Connecting…",
  "settings.backup.connected": "Backup connected.",
  "settings.backup.invalidCode": "Invalid recovery code.",
  ...
  "settings.backup.restoreDone.other": "{count} palettes restored.",
  "settings.backup.restoreFailed": "The restore failed.",
  "settings.backup.copyCode": "Copy code",
  "settings.backup.codeCopied": "Code copied. Keep it somewhere safe.",
  "settings.backup.copyFailed": "Could not copy the code.",
  "settings.backup.disconnect": "Disconnect",
  "settings.backup.disconnectConfirm":
    "Disconnect the backup? Your palettes stay on the server; the recovery code will be needed to reconnect.",
