...
const en = {
  ...
  "config.tabsAria": "Configuration tabs",
  "config.tab.analysis": "Analysis",
  "config.tab.colors": "Color",
  "config.tab.balance": "Balance",
  "config.presets.aria": "Palette presets",
  "config.presets.label": "Presets",
  "config.presets.balanced": "Balanced",
  "config.presets.vivid": "Vivid",
  "config.presets.dynamic": "Dynamic",
  "config.presets.subtle": "Subtle",
  "config.presets.rare": "Rare",
