...
const fr = {
  ...
  "settings.polaroid.colorNames": "Noms des couleurs sur polaroids",
  ...
  "config.tabsAria": "Onglets de configuration",
  "config.tab.analysis": "Analyse",
  "config.tab.colors": "Couleur",
  "config.tab.balance": "Balance",
  "config.presets.aria": "Préréglages de palette",
  "config.presets.label": "Presets",
  "config.presets.balanced": "Équilibré",
  "config.presets.vivid": "Vif",
  "config.presets.dynamic": "Dynamique",
  "config.presets.subtle": "Subtil",
